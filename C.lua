...
local title = Instance.new("TextLabel")
	...
	title.Text = "c00lgui Reborn Rc7 by stummy (better UI)"
...
local t3xt = Instance.new("TextLabel")
	...
	t3xt.Text = "Thank you for using c00lgui version edited scripted! Addons coming soon! Post Ideas in the Thread!!!"
